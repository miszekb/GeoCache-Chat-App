...
class ChatroomLabel extends Component {
  ...
  render() {
    const { chatroom: { _id, name, description, latitude, longitude, isSponsored } } = this.props;
    return(
      <MarkerWithLabel
        ...
        <div className="chatrooms-map__label-content" style={isSponsored ? {border: "5px solid #eabc4f", padding: 10, backgroundColor: "#eee3a1"} : null}>
